...
<head>
	<meta charset="UTF-8">
	<title><?php echo $judul_browser;?> - PT.KMI</title>
...
<body class="skin-blue">
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span><?php if($u_name == 'user'){ echo 'admin'; }else if($u_name == 'admin'){
								echo 'ketua';
	...
	<script type="text/javascript">
	var user = document.querySelector("body > header > nav > div > ul > li:nth-child(3) > a > span")
	console.log(user)
</script>
<script src="<?=base_url();?>/assets/extra/moment-with-locales.js"></script>
</body>
</html>