...
<head>
	<meta charset="UTF-8">
	<title>Pengajuan Baru - PT.KMI</title>
...
<!-- 
					...
					<div class="form-group">
						<?php 
						$attr_form = 'pekerjaan';
						$attr_form_label = 'Jenis Pekerjaan';
						$options = array(
							'HR'		=> 'HR',
					...
					<div class="form-group">
						...
						echo '<label for="'.$attr_form.'">'.$attr_form_label.'</label>
								<div>';
						echo form_dropdown($attr_form, $data, '1000000', 'id="'.$attr_form.'" class="form-control" style="width: 250px;"');
						echo '</div>';
						?>
					</div>
