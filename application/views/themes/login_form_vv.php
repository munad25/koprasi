...
<body>
	...
	<div class="form-box" id="login-box">
		<div class="header"><img height='160' src="<?php echo base_url().'assets/theme_admin/img/logokoperasi.png'; ?>"></div>
		<form action="" method="post">
			...
			<div class="footer"> 
		<div align="center">&copy; Copyright <?php echo date('Y'); ?> |  PT.KMI </div>
			</div>
		</form>
	</div>
